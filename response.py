...
# user = base_request.put('user', 'DS', user_data) #Изменение пользователя
# pprint.pprint(user)

# user2 = base_request.get('user', 'DS') #Получение информации о пользователе
# pprint.pprint(user2)

# delete = base_request.delete('user', 'DS') #Удаление пользователя
# print(delete)